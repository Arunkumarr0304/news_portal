  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.news_box}>
        <Text style={[styles.heading, {color:theme.color}]}>Election Results Overview </Text>
      ...
      <View style={styles.news_box}>
        <Text style={[styles.heading, {color:theme.color}]}>Key Policy Changes </Text>
      ...
      <View style={styles.news_box}>
        <Text style={[styles.heading, {color:theme.color}]}>Impact on Domestic and Foreign Policy </Text>
